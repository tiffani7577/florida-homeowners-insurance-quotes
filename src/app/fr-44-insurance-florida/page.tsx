...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://www.floridahomeownersinsurancequotes.com/fr-44-insurance-florida' },
  openGraph: {
    url: 'https://www.floridahomeownersinsurancequotes.com/fr-44-insurance-florida',
    title: 'FR-44 Insurance Florida 2026 | Requirements',
    description: 'FR-44 insurance in Florida: who needs it, how much it costs, and how to file with the FLHSMV after a DUI conviction.',
